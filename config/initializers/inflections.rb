...
ActiveSupport::Inflector.inflections do |inflect|
  ...
  inflect.plural("grm", "grms")
  inflect.plural("user", "users")
  inflect.plural("status","status")
  inflect.plural("celula","celulas")
  inflect.plural("Icms", "Icms")
  inflect.plural("user_permissao","user_permissoes")
  inflect.plural("user_perfil","user_perfis")
  inflect.plural("CnpjValidator", "CnpjValidator")
  inflect.plural("user_transportadora_filial", "user_transportadora_filiais" )
  ...
  inflect.singular("grms", "grm")
  inflect.singular("users", "user")
  inflect.singular("status","status")
  inflect.singular("carta_pins","carta_pin")
  inflect.singular("perfis","perfil")
  inflect.singular("celulas","celula")
  inflect.singular("Icms","Icms")
  inflect.singular("perfis_controlleres","perfis_controller")
  inflect.singular("user_permissoes","user_permissao")
  inflect.singular("user_perfis","user_perfil")
  inflect.singular("CnpjValidator","CnpjValidator")
  inflect.singular("user_transportadora_filiais","user_transportadora_filial")

  inflect.singular(/fis$/i, 'fil')
